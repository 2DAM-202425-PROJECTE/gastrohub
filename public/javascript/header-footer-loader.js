function loadNavbarFooter() {
    ...
    <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div class="logo-head">
            ...
            <a href="/index.html"><p>GASTROHUB</p></a>
        </div>
...
const cookieHTML = `
  ...
  <div id="cookieAlert" class="hidden fixed bottom-0 left-0 right-0 p-4 shadow-lg z-50">
    <section id="cookieSection" class="fixed p-4 mx-auto bg-white border border-gray-200 dark:bg-gray-800 left-12 bottom-16 dark:border-gray-700 rounded-2xl">
    <h2 id="cookieTitle" class="font-semibold text-gray-800 dark:text-white">🍪 Cookie Notice</h2>
    <p id="cookieText" class="mt-4 text-sm text-gray-600 dark:text-gray-300">We use cookies to ensure that we give you the best experience on our website. <a href="cookie-page.html" class="text-blue-500 hover:underline">Read cookies policies</a>. </p>
